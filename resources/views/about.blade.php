<x-layout>
    ...
    <div class="bg-white shadow-lg rounded-lg p-6">
        ...
        <ul class="list-disc ml-6">
            ...
            <li><p>Our company is dedicated to providing innovative solutions for task management. We believe that effective task management is crucial for productivity and success.</p></li>
            <li><p>With years of experience in the industry, we have developed Task Manager to meet the needs of individuals and teams alike. Our goal is to simplify task management and help you achieve your goals.</p></li>
        </ul>
